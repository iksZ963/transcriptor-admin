// To parse this data:
//
//   import { Convert, RenewalEvent } from "./file";
//
//   const renewalEvent = Convert.toRenewalEvent(json);
//
...
export class Convert {
  public static toRenewalEvent(json: string): RenewalEvent {
    return cast(JSON.parse(json), r("RenewalEvent"));
  }

  public static renewalEventToJson(value: RenewalEvent): string {
    return JSON.stringify(uncast(value, r("RenewalEvent")), null, 2);
  }
}
...
const typeMap: any = {
  ...
  Event: o(
    [
      ...
      { json: "is_trial_conversion", js: "is_trial_conversion", typ: true },
...
export function convertToRenewalEvent(src: any): RenewalEvent {
  return cast(src, r("RenewalEvent"))
}
