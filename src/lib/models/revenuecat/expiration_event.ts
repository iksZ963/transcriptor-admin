// To parse this data:
//
//   import { Convert, ExpirationEvent } from "./file";
//
//   const expirationEvent = Convert.toExpirationEvent(json);
//
...
export class Convert {
  public static toExpirationEvent(json: string): ExpirationEvent {
    return cast(JSON.parse(json), r("ExpirationEvent"));
  }

  public static expirationEventToJson(value: ExpirationEvent): string {
    return JSON.stringify(uncast(value, r("ExpirationEvent")), null, 2);
  }
}
...
const typeMap: any = {
  ...
  Event: o(
    [
      ...
      { json: "expiration_reason", js: "expiration_reason", typ: "" },
      ...
      { json: "tax_percentage", js: "tax_percentage", typ: 3.14 },
      { json: "commission_percentage", js: "commission_percentage", typ: 3.14 },
...
export function converToExpirationEvent(src: any): ExpirationEvent {
  return cast(src, r("ExpirationEvent"));
}